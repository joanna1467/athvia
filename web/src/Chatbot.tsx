...
function scriptedAnswer(q: string): string {
  ...
  if (greetings.some((g) => t.trim().startsWith(g)) && t.length < 20)
    return "Hey! I'm the AthVia recruiting guide. Ask me about eligibility, contacting coaches, divisions (NAIA/D2/D3), scholarships, film, or how AthVia works. What's on your mind?"
  ...
  return "Good question — I don't have a specific answer for that one yet. I'm best at: eligibility rules, when coaches can contact you, emailing coaches (with a template), D2/D3/NAIA differences, scholarships, highlight film, and how AthVia's fit score works. Try one of those — or ask your school counselor for anything super specific to your situation!"
}
